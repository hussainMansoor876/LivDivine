...
mutation($id: String, $userName: String!, $title: String!, $image: String!, $thumbnail: String!, $aboutService: String!, $aboutMe: String!, $video: String!) {
  becomeAdvisor(id: $id, userName: $userName, title: $title, image: $image, aboutService: $aboutService, aboutMe: $aboutMe, isAdvisor: true, isOnline: true, videoThumbnail: $thumbnail, isApproved: true, video: $video, role: "ADVISOR"){
    token, message, success, user {
      id, userName, email, role, image, isVerified, isOnline, authType, title, image,
        aboutService, aboutMe, isAdvisor, isApproved, videoThumbnail, video
    }
